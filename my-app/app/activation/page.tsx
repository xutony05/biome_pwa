      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow p-6">
          ...
          <p className="text-gray-600 mb-4">
            {canViewGuide 
              ? "Follow our step-by-step guide to collect your sample for accurate microbiome analysis."
              : "After completing the activation process above, you'll get access to our step-by-step guide for collecting your sample."
            }
          </p>

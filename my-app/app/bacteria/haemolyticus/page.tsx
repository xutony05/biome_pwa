          ...
          <Card>
            ...
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                S. haemolyticus is a member of the skin microbiome that requires careful monitoring. 
              ...
              <div className={cn(
                ...
                {value > max && (
                  <p className="text-red-800">
                    Your S. haemolyticus levels are above the optimal range. This could potentially lead to 
                ...
                {value < min && (
                  <p className="text-amber-800">
                    Your S. haemolyticus levels are below the optimal range. While this is generally not a concern, 
                ...
                {value >= min && value <= max && (
                  <p className="text-green-800">
                    Great news! Your S. haemolyticus levels are within the optimal range. This suggests your skin's 
